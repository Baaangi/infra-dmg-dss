  ...
  return (
    <main className="p-8 relative min-h-screen">
      ...
      <div className="mb-8 border-b border-white/5 pb-6">
        ...
        <p className="text-zinc-500 text-sm mt-1">Review past inspections and performance metrics.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="glass rounded-lg p-6 border-l-4 border-l-violet-500 flex flex-col justify-center">
            <p className="text-zinc-500 text-sm font-medium uppercase tracking-widest mb-2">Total Inspections</p>
        ...
        <div className="glass rounded-lg p-6 border-l-4 border-l-orange-500 flex flex-col justify-center">
            <p className="text-zinc-500 text-sm font-medium uppercase tracking-widest mb-2">Average Risk Score</p>
        ...
        <div className="glass rounded-lg p-6 border-l-4 border-l-rose-500 flex flex-col justify-center">
            <p className="text-zinc-500 text-sm font-medium uppercase tracking-widest mb-2">High-Risk Structures</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        ...
        <div className="glass rounded-lg p-6 h-72 flex flex-col">
          <h3 className="text-sm font-medium text-zinc-300 mb-4 uppercase tracking-wider">Inspections by Environment</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <h3 className="text-lg font-semibold text-white mb-6 border-b border-white/5 pb-2">Inspection Reports</h3>
