      ...
      <main className="p-8 relative">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-white/5 pb-6">
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1">Monitor infrastructure condition and inspection results.</p>
          </div>
                        ...
                        <div className="mb-6 p-4 rounded-lg bg-violet-900/10 border border-violet-500/20 shadow-sm">
                          ...
                          <div className="p-3 bg-zinc-950/50 rounded-md border-l-2 border-amber-500">
                            <p className="text-sm text-amber-200/90 font-medium">
                              <strong className="text-amber-500 mr-2 uppercase tracking-wider text-[10px]">Findings:</strong>
