    ...
    return (
        <div className="w-64 border-r border-white/5 bg-[#09090b] text-zinc-400 h-screen flex flex-col fixed left-0 top-0 z-20 shadow-2xl">
            ...
            <nav className="flex-1 px-3 py-4 space-y-2">
                ...
                <NavButton href="/history" icon={<ClockIcon className="w-5 h-5" />} text="History Record" active={pathname === "/history"} />
                <NavButton href="/profile" icon={<UserCircleIcon className="w-5 h-5" />} text="Manage Profile" active={pathname === "/profile"} />
